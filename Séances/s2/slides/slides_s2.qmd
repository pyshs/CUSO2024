...
- L'exécuter :
    ...
    - En le copiant dans un notebooks
        - Soit local
...
- Dans beaucoup de situation, pas de souci pour sauter une ligne (après une virgule)
...
- Un script est un écoulement d'instruction
...
Pour chaque élément de `liste_mots`, la condition teste si sa longueur est supérieur à la valeur de la variable `nombre_min_lettres`
...
- dictionnaire bon conteneurs
    - penser au format JSON : dictionnaires, listes, valeurs

---

## Ligne 15 : formattage de chaîne de caractères
...
Similaire, mais avec l'option `r`, et les méthodes `read`
