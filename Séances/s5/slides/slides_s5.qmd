...
## Soyons honnête : plus laborieux que R
...
- Les tri à plat sont faciles à faire aussi
...
## Exemple de la régression logistique binomiale

Rappel : une régression logistique est une modélisation sur d'une variable binaire où on régresse une fonction spécifique (la fonction logit) de la probabilité de la variable d'avoir les valeurz 1/0 comme une combinaison linéaire des variables inépendantes

il faut donc :

- une variable binaire
- des variables indépendantes catégorielles ou continue
...
- Présenter Plotly
- Dire un mot la philosophie de son usage
- Refaire la série temporelle présentée en démo lors de la séance 1.
