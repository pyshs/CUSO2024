...
- Vous
    ...
    - Le type de données ?
    - Dans l'idéal, quel usage de Python si vous avez une idée ?
...
- Se familiariser aux environnements informatiques
    - Ligne de commande, ..
- Penser la structures des données et leurs diversités
...
![Choisir](img/choisir.png){style="display:block; margin:auto;"}
...
- Une ligne de code
- Un ensemble de ligne de code dans un fichier
